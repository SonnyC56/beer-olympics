...
export const gamificationRouter = router({
    ...
    awardXP: publicProcedure
        ...
        .mutation(async ({ input }) => {
        return await xpSystem.awardXP(input.userId, input.amount, input.reason, input.context);
    }),
    ...
    submitVote: publicProcedure
        ...
        .mutation(async ({ input }) => {
        return await votingSystem.submitVote(input.tournamentId, input.categoryId, input.voterId, input.nomineeId, input.nomineeType);
    }),
