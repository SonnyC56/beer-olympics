...
export const MaterialThemeProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  return (
    <MaterialThemeContext.Provider value={materialTheme}>
      {children}
...
export const getElevation = (level: keyof typeof materialTheme.elevation) => {
  return materialTheme.elevation[level];
};

// Helper function to apply state layer
export const getStateLayerOpacity = (state: keyof typeof materialTheme.stateLayer) => {
