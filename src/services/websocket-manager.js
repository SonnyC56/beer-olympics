...
export class WebSocketConnectionPool extends EventEmitter {
    constructor(endpoints, config) {
        ...
        Object.defineProperty(this, "channelToConnection", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Map()
        ...
        Object.defineProperty(this, "healthCheckTimer", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    async getConnectionForChannel(channel) {
    ...
    async findOrCreateBestConnection() {
    ...
    async scheduleReconnection(connection) {
        const backoff = Math.min(this.config.reconnectBackoff.initial *
            Math.pow(this.config.reconnectBackoff.multiplier, connection.reconnectAttempts), this.config.reconnectBackoff.max);
...
Object.defineProperty(BinaryProtocol, "MESSAGE_TYPES", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: {
