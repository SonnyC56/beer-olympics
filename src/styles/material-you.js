 ...
 */
import { argbFromHex, hexFromArgb, TonalPalette, Hct, MaterialDynamicColors, DynamicScheme, SchemeContent, SchemeExpressive, SchemeFidelity, SchemeMonochrome, SchemeNeutral, SchemeTonalSpot, SchemeVibrant, Blend } from '@material/material-color-utilities';
...
export class SchemeParty extends DynamicScheme {
    constructor(sourceColorHct, isDark, contrastLevel) {
        super({
            ...
            secondaryPalette: TonalPalette.fromHueAndChroma(sourceColorHct.hue + 30, // Shift hue for variety
            Math.max(40, sourceColorHct.chroma * 0.8)),
            tertiaryPalette: TonalPalette.fromHueAndChroma(sourceColorHct.hue + 60, // More hue shift
 ...
 */
export function generateMaterialYouTheme(sourceColor, schemeType = 'expressive', customColors) {
 ...
 */
export function applyMaterialYouTheme(theme, isDark = false) {
 ...
 */
export async function generateThemeFromImage(imageElement, schemeType = 'expressive') {
 ...
 */
export function initializeMaterialYou(preferredScheme = 'party', darkMode = false) {
