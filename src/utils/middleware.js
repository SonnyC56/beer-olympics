...
export function createCacheMiddleware(options = {}) {
    const { ttl = CACHE_TTL.DEFAULT, keyGenerator = (req) => getApiCacheKey(req.method, req.path, req.query), condition = (req) => req.method === 'GET', skipCache = () => false, } = options;
...
export function createInvalidationMiddleware(patterns) {
    return async (req, res, next) => {
